...
// QUnit.test(
// 	'actor/setObjectHoveredState creation and deletion has a pointermove event added/removed without the need to have a event/pointermove node',
// 	async (assert) => {
...
// 		setObjectHoveredState1.setInput(ActorConnectionPointType.TRIGGER, onEventTick1);
// 		setObjectScale1.setInput(ActorConnectionPointType.TRIGGER, onEventObjectAttributeUpdated1);
