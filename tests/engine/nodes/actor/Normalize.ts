...
QUnit.test('actor/normalize with vector2 inputs', async (assert) => {
	...
	vec2ToVec3_1.setInput('vec2', normalize);
...
QUnit.test('actor/normalize with vector3 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
...
QUnit.test('actor/normalize with vector4 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
	...
	vec4ToVec3_1.setInput('vec4', normalize);
