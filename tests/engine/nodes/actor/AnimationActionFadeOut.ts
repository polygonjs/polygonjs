...
QUnit.test('actor/animationActionFadeOut', async (assert) => {
	...
	animationActionFadeOut1.setInput(ActorConnectionPointType.ANIMATION_ACTION, animationAction_Attack);
	animationActionPlay1.setInput(ActorConnectionPointType.ANIMATION_ACTION, animationAction_Death);
	...
	await RendererUtils.withViewer({cameraNode: perspective_camera1}, async (args) => {
		...
		animationActionPlay1.p.trigger.pressButton();
		await CoreSleep.sleep(500);
		...
		animationActionFadeOut1.p.trigger.pressButton();
		await CoreSleep.sleep(500);
