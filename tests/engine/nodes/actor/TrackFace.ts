...
QUnit.test('actor/trackFace', async (assert) => {
	...
	video1.p.url.set(`${ASSETS_ROOT}/computerVision/tests/face.mp4`);
	...
	trackFace1.setInput(ActorConnectionPointType.TRIGGER, onTick1);
