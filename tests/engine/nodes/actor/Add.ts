...
QUnit.test('actor/add for more than 2 inputs float', async (assert) => {
...
QUnit.test('actor/add with 2 inputs float', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
...
QUnit.test('actor/add with 2 inputs vector', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
...
QUnit.test('actor/add with 2 inputs vector from attrib to pos', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
