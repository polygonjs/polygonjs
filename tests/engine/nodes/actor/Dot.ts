...
QUnit.test('actor/dot with vector2 inputs', async (assert) => {
...
QUnit.test('actor/dot with vector3 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
...
QUnit.test('actor/dot with vector4 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
