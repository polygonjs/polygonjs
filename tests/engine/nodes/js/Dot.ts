...
export function testenginenodesjsDot(qUnit: QUnit) {

qUnit.test('js/dot with vector2 inputs', async (assert) => {
	...
	const dot = actor1.createNode('dot');
	...
	floatToVec3_1.setInput('y', dot);

	dot.setInput(0, constant1);
...
qUnit.test('js/dot with vector3 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
...
qUnit.test('js/dot with vector4 inputs', async (assert) => {
	const scene = window.scene;
	const perspective_camera1 = window.perspective_camera1;
