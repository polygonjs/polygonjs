...
import {triggerContextMenuAside, triggerContextMenuInMiddle, triggerContextMenu} from '../../../helpers/EventsHelper';
import {RendererUtils} from '../../../helpers/RendererUtils';
export function testenginenodesjsOnObjectContextMenu(qUnit: QUnit) {
	qUnit.test('js/onObjectContextMenu', async (assert) => {
		...
		const onObjectContextMenu1 = actor1.createNode('onObjectContextMenu');
		...
		setObjectPosition1.setInput(JsConnectionPointType.TRIGGER, onObjectContextMenu1);
		// setObjectPosition1.p.position.set([0, 0, 1]);
		setObjectPosition1.setInput('position', negate1);
		negate1.setInput(0, getObjectProperty1);
		//
		getIntersectionProperty1.setInput(0, onObjectContextMenu1, JsConnectionPointType.INTERSECTION);
		setParam1.setInput(JsConnectionPointType.TRIGGER, onObjectContextMenu1);
		setParam1.setInput(
