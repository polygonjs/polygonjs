...
export function testenginenodesjsOnChildAttributeUpdate(qUnit: QUnit) {
	qUnit.test('js/onChildAttributeUpdate', async (assert) => {
		...
		onChildAttributeUpdate1.setAttribName('selected');

		setObjectPosition1.setInput(JsConnectionPointType.TRIGGER, onChildAttributeUpdate1);
