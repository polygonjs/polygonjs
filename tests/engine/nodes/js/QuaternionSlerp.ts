...
qUnit.test('js/quaternionSlerp', async (assert) => {
	...
	const quaternionSlerp1 = objectBuilder1.createNode('quaternionSlerp');
	...
	quaternionSlerp1.setInput(0, quaternion1);
	quaternionSlerp1.setInput(1, quaternion2);
	quaternionAngleTo1.setInput(0, quaternion1);
	quaternionAngleTo1.setInput(1, quaternionSlerp1);
