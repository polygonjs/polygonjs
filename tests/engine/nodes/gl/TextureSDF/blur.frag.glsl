...
uniform sampler3D v_POLY_textureSDF_texture1;
SDFContext GetDist(vec3 p) {
	SDFContext sdfContext = SDFContext(0., 0, 0, 0, 0.);
	vec3 v_POLY_textureSDF1_boundCenter = (vec3(1.0, 1.0, 1.0) + vec3(0.0, 0.0, 0.0))*0.5;
	vec3 v_POLY_textureSDF1_boundSize = (vec3(1.0, 1.0, 1.0) - vec3(0.0, 0.0, 0.0));
	vec3 v_POLY_textureSDF1_positionNormalised = ((p - vec3(0.0, 0.0, 0.0)) / v_POLY_textureSDF1_boundSize);
	float v_POLY_textureSDF1_sdBox = sdBox(p-v_POLY_textureSDF1_boundCenter, v_POLY_textureSDF1_boundSize*vec3(1.0, 1.0, 1.0));
	float v_POLY_textureSDF1_d = v_POLY_textureSDF1_sdBox < 0.01 ? ((
					texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,-1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,-1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,-1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,0.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,0.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,0.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,1.0*0.01,-1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,-1.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,-1.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,-1.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,0.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,0.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,0.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(-1.0*0.01,1.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,1.0*0.01,0.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,1.0*0.01,0.0*0.01)).r +
...
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(0.0*0.01,1.0*0.01,1.0*0.01)).r +
texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionNormalised - vec3(0.0, 0.0, 0.0)+vec3(1.0*0.01,1.0*0.01,1.0*0.01)).r
				)/27.0) : v_POLY_textureSDF1_sdBox;
	
	SDFContext v_POLY_SDFContext1_SDFContext = SDFContext(v_POLY_textureSDF1_d, 0, -1, -1, 0.);
...
vec3 GetLight(vec3 _p, vec3 _n, inout SDFContext sdfContext) {
	...
	geometry.viewDir = ( isOrthographic ) ? vec3( 0, 0, 1 ) : normalize( cameraPosition - geometry.position );
		...
		vec3 lightPos, lightDir, worldLightDir, objectSpaceLightDir;		vec3 lighDif;
		#if NUM_SPOT_LIGHTS > 0
			...
			for ( int i = 0; i < NUM_DIR_LIGHTS; i ++ ) {
				...
				dirLightSdfShadow = calcSoftshadow(
					...
					objectSpaceLightDir,
					10.*SURF_DIST,
					MAX_DIST,					1./max(directionalLightRayMarching.penumbra*0.2,0.001),
					sdfContext
				);
