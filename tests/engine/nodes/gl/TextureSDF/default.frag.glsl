...
SDFContext GetDist(vec3 p) {
	...
	vec3 v_POLY_textureSDF1_positionRefit = ((p - vec3(0.0, 0.0, 0.0)) / v_POLY_textureSDF1_boundSize);
	float v_POLY_textureSDF1_sdBox = sdBox(p-v_POLY_textureSDF1_boundCenter, v_POLY_textureSDF1_boundSize);
	float v_POLY_textureSDF1_d = v_POLY_textureSDF1_sdBox < 0.01 ? texture(v_POLY_textureSDF_texture1, v_POLY_textureSDF1_positionRefit - vec3(0.0, 0.0, 0.0)).r : v_POLY_textureSDF1_sdBox;
	
	SDFContext v_POLY_SDFContext1_SDFContext = SDFContext(v_POLY_textureSDF1_d, -1);
