...
SDFContext GetDist(vec3 p) {
	...
	float v_POLY_SDF2DHeart1_float = sdHeart(v_POLY_SDFRevolution1_p - vec2(0.0, 0.0));
	
	SDFContext v_POLY_SDFContext1_SDFContext = SDFContext(v_POLY_SDF2DHeart1_float, 0, -1, -1, 0.);
