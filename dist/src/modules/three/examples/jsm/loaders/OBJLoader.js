    ...
    parse: function(text) {
      ...
      if (hasPrimitives === true) {
        for (var i = 0, l = state.objects.length; i < l; i++) {
          ...
          for (var mi = 0, miLen = materials.length; mi < miLen; mi++) {
            ...
            if (this.materials !== null) {
              ...
              if (isLine && material && !(material instanceof LineBasicMaterial2)) {
                var materialLine = new LineBasicMaterial2();
                Material2.prototype.copy.call(materialLine, material);
                materialLine.color.copy(material.color);
                material = materialLine;
              } else if (isPoints && material && !(material instanceof PointsMaterial2)) {
                var materialPoints = new PointsMaterial2({size: 10, sizeAttenuation: false});
                Material2.prototype.copy.call(materialPoints, material);
            ...
            if (material === void 0) {
              if (isLine) {
                ...
                material = new PointsMaterial2({size: 1, sizeAttenuation: false});
              } else {
          ...
          if (createdMaterials.length > 1) {
            ...
            if (isLine) {
              mesh = new LineSegments2(buffergeometry, createdMaterials);
            } else if (isPoints) {
              mesh = new Points2(buffergeometry, createdMaterials);
            } else {
              mesh = new Mesh2(buffergeometry, createdMaterials);
            }
          } else {
            if (isLine) {
              mesh = new LineSegments2(buffergeometry, createdMaterials[0]);
            } else if (isPoints) {
              mesh = new Points2(buffergeometry, createdMaterials[0]);
            } else {
              mesh = new Mesh2(buffergeometry, createdMaterials[0]);
            }
          }
        ...
        if (state.vertices.length > 0) {
          var material = new PointsMaterial2({size: 1, sizeAttenuation: false});
          var buffergeometry = new BufferGeometry2();
          ...
          var points = new Points2(buffergeometry, material);
