import {CompressedTexture as CompressedTexture2} from "three/src/textures/CompressedTexture";
...
BasisTextureLoader.prototype = Object.assign(Object.create(Loader2.prototype), {
    ...
    var texturePending = this._allocateWorker(taskCost).then((_worker) => {
      ...
      switch (format) {
        case BasisTextureLoader.BASIS_FORMAT.cTFASTC_4x4:
          texture = new CompressedTexture2(mipmaps, width, height, RGBA_ASTC_4x4_Format);
          break;
        case BasisTextureLoader.BASIS_FORMAT.cTFBC7_M5:
          texture = new CompressedTexture2(mipmaps, width, height, RGBA_BPTC_Format);
          break;
        case BasisTextureLoader.BASIS_FORMAT.cTFBC1:
        case BasisTextureLoader.BASIS_FORMAT.cTFBC3:
          texture = new CompressedTexture2(mipmaps, width, height, BasisTextureLoader.DXT_FORMAT_MAP[config.format], UnsignedByteType);
          break;
        case BasisTextureLoader.BASIS_FORMAT.cTFETC1:
          texture = new CompressedTexture2(mipmaps, width, height, RGB_ETC1_Format);
          break;
        case BasisTextureLoader.BASIS_FORMAT.cTFPVRTC1_4_RGB:
          texture = new CompressedTexture2(mipmaps, width, height, RGB_PVRTC_4BPPV1_Format);
          break;
        case BasisTextureLoader.BASIS_FORMAT.cTFPVRTC1_4_RGBA:
          texture = new CompressedTexture2(mipmaps, width, height, RGBA_PVRTC_4BPPV1_Format);
          break;
        default:
  ...
  _initTranscoder: function() {
    if (!this.transcoderPending) {
      var jsLoader = new FileLoader2(this.manager);
      jsLoader.setPath(this.transcoderPath);
      jsLoader.setWithCredentials(this.withCredentials);
      var jsContent = new Promise((resolve, reject) => {
        jsLoader.load("basis_transcoder.js", resolve, void 0, reject);
      });
      var binaryLoader = new FileLoader2(this.manager);
