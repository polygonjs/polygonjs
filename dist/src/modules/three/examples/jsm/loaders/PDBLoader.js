...
PDBLoader.prototype = Object.assign(Object.create(Loader2.prototype), {
  ...
  parse: function(text) {
    ...
    function hash(s, e2) {
      return "s" + Math.min(s, e2) + "e" + Math.max(s, e2);
    }
    ...
    function buildGeometry() {
      var build = {
        geometryAtoms: new BufferGeometry2(),
        geometryBonds: new BufferGeometry2(),
        json: {
          atoms
        }
      };
      ...
      var colorsAtoms = [];
      var verticesBonds = [];
      for (i2 = 0, l2 = atoms.length; i2 < l2; i2++) {
        var atom = atoms[i2];
        x2 = atom[0];
        y2 = atom[1];
        z2 = atom[2];
        verticesAtoms.push(x2, y2, z2);
        var r = atom[3][0] / 255;
        var g = atom[3][1] / 255;
        var b = atom[3][2] / 255;
        colorsAtoms.push(r, g, b);
      }
      for (i2 = 0, l2 = _bonds.length; i2 < l2; i2++) {
        var bond = _bonds[i2];
        var start = bond[0];
        var end = bond[1];
