...
var BufferGeometryUtils = {
  computeTangents: function(geometry) {
    ...
    if (attributes.tangent === void 0) {
      geometry.setAttribute("tangent", new BufferAttribute2(new Float32Array(4 * nVertices), 4));
    }
    ...
    var tmp = new Vector32(), tmp2 = new Vector32();
  ...
  mergeBufferGeometries: function(geometries, useGroups) {
    ...
    var mergedGeometry = new BufferGeometry2();
    var offset = 0;
  ...
  mergeBufferAttributes: function(attributes) {
    ...
    return new BufferAttribute2(array, itemSize, normalized);
  },
  interleaveAttributes: function(attributes) {
    ...
    var interleavedBuffer = new InterleavedBuffer2(new TypedArray(arrayLength), stride);
    var offset = 0;
    var res = [];
    ...
    for (var j = 0, l = attributes.length; j < l; j++) {
      ...
      var iba = new InterleavedBufferAttribute2(interleavedBuffer, itemSize, offset, attribute.normalized);
      res.push(iba);
      offset += itemSize;
  ...
  mergeVertices: function(geometry, tolerance = 1e-4) {
    ...
    for (var i = 0, l = attributeNames.length; i < l; i++) {
      ...
      var attribute = new BufferAttribute2(buffer, oldAttribute.itemSize, oldAttribute.normalized);
      result.setAttribute(name, attribute);
      if (name in morphAttrsArrays) {
        for (var j = 0; j < morphAttrsArrays[name].length; j++) {
          var oldMorphAttribute = geometry.morphAttributes[name][j];
          var buffer = new oldMorphAttribute.array.constructor(morphAttrsArrays[name][j]);
          var morphAttribute = new BufferAttribute2(buffer, oldMorphAttribute.itemSize, oldMorphAttribute.normalized);
