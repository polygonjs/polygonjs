...
SubdivisionModifier.prototype.modify = function(geometry) {
  ...
  if (isBufferGeometry) {
    return new BufferGeometry2().fromGeometry(geometry);
  } else {
    return geometry;
  }
};
(function() {
  ...
  function newFace(newFaces, a, b, c, materialIndex) {
    newFaces.push(new Face32(a, b, c, void 0, void 0, materialIndex));
  }
  ...
  SubdivisionModifier.prototype.smooth = function(geometry) {
    ...
    var hasUvs = oldUvs[0] !== void 0 && oldUvs[0].length > 0;
    if (hasUvs) {
