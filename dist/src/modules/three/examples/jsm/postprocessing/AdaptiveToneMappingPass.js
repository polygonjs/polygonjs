...
import {LuminosityShader as LuminosityShader2} from "../shaders/LuminosityShader.js";
import {ToneMapShader as ToneMapShader2} from "../shaders/ToneMapShader.js";
var AdaptiveToneMappingPass = function(adaptive, resolution) {
  ...
  if (LuminosityShader2 === void 0)
    console.error("AdaptiveToneMappingPass relies on LuminosityShader");
  this.materialLuminance = new ShaderMaterial2({
    uniforms: UniformsUtils2.clone(LuminosityShader2.uniforms),
    vertexShader: LuminosityShader2.vertexShader,
    fragmentShader: LuminosityShader2.fragmentShader,
    blending: NoBlending
  });
  ...
  this.materialAdaptiveLum = new ShaderMaterial2({
    uniforms: UniformsUtils2.clone(this.adaptLuminanceShader.uniforms),
    vertexShader: this.adaptLuminanceShader.vertexShader,
    fragmentShader: this.adaptLuminanceShader.fragmentShader,
    defines: Object.assign({}, this.adaptLuminanceShader.defines),
    blending: NoBlending
  });
  if (ToneMapShader2 === void 0)
    console.error("AdaptiveToneMappingPass relies on ToneMapShader");
  this.materialToneMap = new ShaderMaterial2({
    uniforms: UniformsUtils2.clone(ToneMapShader2.uniforms),
    vertexShader: ToneMapShader2.vertexShader,
    fragmentShader: ToneMapShader2.fragmentShader,
    blending: NoBlending
  });
...
AdaptiveToneMappingPass.prototype = Object.assign(Object.create(Pass2.prototype), {
  ...
  reset: function() {
    ...
    this.luminanceRT = new WebGLRenderTarget2(this.resolution, this.resolution, pars);
    this.luminanceRT.texture.name = "AdaptiveToneMappingPass.l";
    this.luminanceRT.texture.generateMipmaps = false;
    this.previousLuminanceRT = new WebGLRenderTarget2(this.resolution, this.resolution, pars);
    this.previousLuminanceRT.texture.name = "AdaptiveToneMappingPass.pl";
    this.previousLuminanceRT.texture.generateMipmaps = false;
    pars.minFilter = LinearMipmapLinearFilter;
    pars.generateMipmaps = true;
    this.currentLuminanceRT = new WebGLRenderTarget2(this.resolution, this.resolution, pars);
    this.currentLuminanceRT.texture.name = "AdaptiveToneMappingPass.cl";
    if (this.adaptive) {
      this.materialToneMap.defines["ADAPTED_LUMINANCE"] = "";
      this.materialToneMap.uniforms.luminanceMap.value = this.luminanceRT.texture;
    }
    this.fsQuad.material = new MeshBasicMaterial2({color: 7829367});
