...
import {LuminosityHighPassShader as LuminosityHighPassShader2} from "../shaders/LuminosityHighPassShader.js";
var UnrealBloomPass = function(resolution, strength, radius, threshold) {
  ...
  this.clearColor = new Color2(0, 0, 0);
  ...
  this.renderTargetBright = new WebGLRenderTarget2(resx, resy, pars);
  this.renderTargetBright.texture.name = "UnrealBloomPass.bright";
  this.renderTargetBright.texture.generateMipmaps = false;
  for (var i = 0; i < this.nMips; i++) {
    var renderTargetHorizonal = new WebGLRenderTarget2(resx, resy, pars);
    renderTargetHorizonal.texture.name = "UnrealBloomPass.h" + i;
    renderTargetHorizonal.texture.generateMipmaps = false;
    this.renderTargetsHorizontal.push(renderTargetHorizonal);
    var renderTargetVertical = new WebGLRenderTarget2(resx, resy, pars);
  ...
  if (LuminosityHighPassShader2 === void 0)
    console.error("UnrealBloomPass relies on LuminosityHighPassShader");
  var highPassShader = LuminosityHighPassShader2;
  ...
  for (var i = 0; i < this.nMips; i++) {
    ...
    this.separableBlurMaterials[i].uniforms["texSize"].value = new Vector22(resx, resy);
    resx = Math.round(resx / 2);
    resy = Math.round(resy / 2);
  }
  ...
  this.basic = new MeshBasicMaterial2();
