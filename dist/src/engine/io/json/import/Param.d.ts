...
export declare class ParamJsonImporter<T extends BaseParamType> {
    ...
    static non_spare_params_data_value(params_data?: Dictionary<ParamJsonExporterData<ParamType>>): Dictionary<string | number | boolean | StringOrNumber3 | import("../../../params/ramp/RampValue").RampValueJson | StringOrNumber2 | StringOrNumber4 | null> | undefined;
