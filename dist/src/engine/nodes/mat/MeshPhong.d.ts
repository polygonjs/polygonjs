...
declare class MeshPhongMatParamsConfig extends MeshPhongMatParamsConfig_base {
    flat_shading: import("../utils/params/ParamsConfig").ParamTemplate<import("../../poly/ParamType").ParamType.BOOLEAN>;
}
export declare class MeshPhongMatNode extends TypedMatNode<MeshPhongMaterial, MeshPhongMatParamsConfig> {
    params_config: MeshPhongMatParamsConfig;
    static type(): string;
    create_material(): MeshPhongMaterial;
