...
export declare class ShaderAssemblerLine extends ShaderAssemblerMaterial {
    ...
    static output_input_connection_points(): (GlConnectionPoint<GlConnectionPointType.FLOAT> | GlConnectionPoint<GlConnectionPointType.VEC3> | GlConnectionPoint<GlConnectionPointType.VEC2>)[];
