...
export declare class BaseGlShaderAssembler extends TypedAssembler<BaseGlNodeType> {
    ...
    builder_param_configs(): readonly import("../utils/ParamConfig").GlParamConfig<ParamType>[];
    ...
    param_configs(): readonly import("../utils/ParamConfig").GlParamConfig<ParamType>[];
