...
class LabToRgbGlParamsConfig extends NodeParamsConfig {
  constructor() {
    super(...arguments);
    this.lab = ParamConfig.VECTOR3([1, 1, 1]);
  }
}
const ParamsConfig2 = new LabToRgbGlParamsConfig();
export class LabToRgbGlNode extends TypedGlNode {
  constructor() {
    super(...arguments);
  ...
  set_lines(shaders_collection_controller) {
    ...
    const value = ThreeToGl2.vector3(this.variable_for_input(this.p.lab.name));
