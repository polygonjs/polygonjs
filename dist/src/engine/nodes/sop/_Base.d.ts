...
declare class BaseNetworkSopParamsConfig extends NodeParamsConfig {
}
export declare class BaseNetworkSopNode extends TypedNode<NodeContext.SOP, BaseNetworkSopParamsConfig> {
