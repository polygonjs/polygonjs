...
declare class PhysicsConstraintAttributesSopParamsConfig extends NodeParamsConfig {
...
export declare class PhysicsConstraintAttributesSopNode extends TypedSopNode<PhysicsConstraintAttributesSopParamsConfig> {
    params_config: PhysicsConstraintAttributesSopParamsConfig;
    static type(): string;
