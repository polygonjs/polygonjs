...
export declare class EventsSopNode extends ParamLessBaseNetworkSopNode {
    static type(): NetworkNodeType;
    protected _children_controller_context: NodeContext;
    createNode<S extends keyof EventNodeChildrenMap>(node_class: S, params_init_value_overrides?: ParamsInitData): EventNodeChildrenMap[S];
