...
export declare abstract class BaseLightHelper<L extends Light, N extends BaseLightHelperObjNode<L>> {
    protected node: N;
    private _name;
    protected _object: Mesh<import("three").Geometry | import("three").BufferGeometry, import("three").Material | import("three").Material[]>;
    protected _material: MeshBasicMaterial;
    constructor(node: N, _name: string);
    build(): void;
    protected abstract build_helper(): void;
    get object(): Mesh<import("three").Geometry | import("three").BufferGeometry, import("three").Material | import("three").Material[]>;
