...
export declare class ParamsController {
    ...
    value(name: string): string | number | boolean | import("three").Color | import("three").Vector2 | import("three").Vector3 | import("three").Vector4 | import("../../../params/ramp/RampValue").RampValue | null | undefined;
    ...
    add_param<T extends ParamType>(type: T, name: string, default_value: ParamInitValuesTypeMap[T], options?: ParamOptions, init_value?: ParamInitValuesTypeMap[T]): ParamConstructorMap[T] | undefined;
