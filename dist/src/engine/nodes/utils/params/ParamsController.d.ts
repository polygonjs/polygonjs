...
export declare class ParamsController {
    ...
    value(param_name: string): string | number | boolean | import("three").Color | import("../../../../core/Walker").TypedPathParamValue | import("../../../params/ramp/RampValue").RampValue | import("three").Vector2 | import("three").Vector3 | import("three").Vector4 | null | undefined;
