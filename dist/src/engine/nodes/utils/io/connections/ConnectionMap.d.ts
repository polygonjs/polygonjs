...
export declare function create_connection_point<NC extends NodeContext>(context: NC, name: string, type: ConnectionPointEnumMap[NC]): GlConnectionPoint<GlConnectionPointType> | EventConnectionPoint<EventConnectionPointType> | JsConnectionPoint<JsConnectionPointType> | undefined;
