...
export declare function create_connection_point<NC extends NodeContext>(context: NC, name: string, type: ConnectionPointEnumMap[NC]): EventConnectionPoint<EventConnectionPointType> | JsConnectionPoint<JsConnectionPointType> | GlConnectionPoint<GlConnectionPointType> | undefined;
