...
export declare function create_connection_point<NC extends NodeContext>(context: NC, name: string, type: ConnectionPointEnumMap[NC]): JsConnectionPoint<JsConnectionPointType> | EventConnectionPoint<EventConnectionPointType> | GlConnectionPoint<GlConnectionPointType> | undefined;
