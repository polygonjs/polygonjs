...
export declare class CoreTextureLoader {
    ...
    loader_for_ext(ext: string): Promise<import("../../../modules/three/examples/jsm/loaders/EXRLoader").EXRLoader | import("../../../modules/three/examples/jsm/loaders/RGBELoader").RGBELoader | import("../../../modules/three/examples/jsm/loaders/BasisTextureLoader").BasisTextureLoader | TextureLoader>;
