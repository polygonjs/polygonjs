...
export declare class CoreLoaderGeometry {
    ...
    loader_for_obj(): Promise<import("../../../modules/three/examples/jsm/loaders/OBJLoader2").OBJLoader2>;
    loader_for_fbx(): Promise<import("../../../modules/three/examples/jsm/loaders/FBXLoader").FBXLoader>;
}
