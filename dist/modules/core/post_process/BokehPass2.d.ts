...
export declare class BokehPass2 {
    ...
    clear_color: Color;
    private _camera;
    constructor(_depth_of_field_node: DepthOfFieldPostNode, _scene: Scene, _camera_node: PerspectiveCameraObjNode, _resolution: Vector2);
    setSize(width: number, height: number): void;
    dispose(): void;
    render(renderer: WebGLRenderer, writeBuffer: WebGLRenderTarget, readBuffer: WebGLRenderTarget): void;
    update_camera_uniforms_with_node(node: DepthOfFieldPostNode, camera_node: PerspectiveCameraObjNode): void;
}
export {};
