...
export declare class ParamSerializer {
    ...
    value(): string | number | boolean | Number3 | RampValueJson | Number2 | Number4 | null;
...
declare const Vec2ToFloatGlNode_base: {
    new (scene: PolyScene, name?: string): {
        ...
        container_controller: GlContainer>;
        ...
        _cook_controller: CookController | undefined;
        ...
        _processing_context: ProcessingContext | undefined;
        _name_controller: NameController | undefined;
        _io: BaseGlNodeType> | undefined;
...
export declare class CompareGlNode extends TypedGlNode<CompareGlParamsConfig> {
    ...
    initialize_node(): void;
    protected _gl_input_name(index: number): string;
    protected _expected_input_type(): ConnectionPointType[];
    set_lines(shaders_collection_controller: ShadersCollectionController): void;
}
export {};
...
export declare class InputsController<T extends BaseNodeType> {
    ...
    eval_required_inputs(): Promise<(BaseContainer | null)[]>;
