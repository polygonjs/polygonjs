...
// 		this.processing.camera = new THREE.OrthographicCamera(
// 			this._resolution[0] / -2,
// 			this._resolution[0] / 2,
// 			this._resolution[1] / 2,
// 			this._resolution[1] / -2,
// 			-10000,
// 			10000
// 		);
...
// 		this.processing.quad = new THREE.Mesh(
// 			new THREE.PlaneBufferGeometry(this._resolution[0], this._resolution[1]),
// 			this.processing.materialBokeh
// 		);
