/**
 * Steps through a soft solver simulation
 *
 *
 */
...
// enum SoftBodySolverStepSimulationOutput {
// 	TEXTURE_SIZE = 'tSize',
...
export class SoftBodySolverStepSimulationJsNode extends TypedJsNode<SoftBodySolverStepSimulationJsParamsConfig> {
	...
	override initializeNode() {
		...
		this.io.outputs.setNamedOutputConnectionPoints([
			...
			// new JsConnectionPoint(SoftBodySolverStepSimulationOutput.TEXTURE_SIZE, JsConnectionPointType.VECTOR2),
			// new JsConnectionPoint(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION0, JsConnectionPointType.TEXTURE),
			// new JsConnectionPoint(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION1, JsConnectionPointType.TEXTURE),
			// new JsConnectionPoint(SoftBodySolverStepSimulationOutput.TEXTURE_NORMAL, JsConnectionPointType.TEXTURE),
			// new JsConnectionPoint(SoftBodySolverStepSimulationOutput.MATERIAL_INTEGRATION, JsConnectionPointType.MATERIAL),
			//
	...
	// 	const tSize = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_SIZE);
	// 	const tPosition0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION0);
	// 	const tPosition1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION1);
	// 	const tNormal = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_NORMAL);
	// 	//
	// 	const tOriginalRT = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_ORIGINAL_RT);
	// 	const tViscositySpringT = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_VISCOSITY_SPRING_T);
	// 	const tPreviousRT0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_PREVIOUS_RT0);
	// 	const tPreviousRT1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_PREVIOUS_RT1);
	// 	const tTargetRT0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_TARGET_RT0);
	// 	const tTargetRT1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_TARGET_RT1);

	// 	const tNormalsRT = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_NORMALS_RT);
	// 	const tPositionRT0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION_RT0);
	// 	const tPositionRT1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_POSITION_RT1);

	// 	const tAdjacentsRT0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_ADJACENT_RT0);
	// 	const tAdjacentsRT1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_ADJACENT_RT1);
	// 	const tDistanceRT0 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_DISTANCE_RT0);
	// 	const tDistanceRT1 = this.jsVarName(SoftBodySolverStepSimulationOutput.TEXTURE_DISTANCE_RT1);

	// 	const integrationMat = this.jsVarName(SoftBodySolverStepSimulationOutput.MATERIAL_INTEGRATION);
