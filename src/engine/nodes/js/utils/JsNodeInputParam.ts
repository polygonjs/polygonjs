...
// type JsNodeParamConstructorMapType = {[key in ParamType]: TypedParam<ParamType>};
// export interface JsNodeParamConstructorMap extends JsNodeParamConstructorMapType {
