...
const ParamsConfig = new PhysicsRBDAddForceActorParamsConfig();

export class PhysicsRBDAddForceActorNode extends TypedActorNode<PhysicsRBDAddForceActorParamsConfig> {
