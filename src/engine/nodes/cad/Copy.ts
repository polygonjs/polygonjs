...
// }
// const ParamsConfig = new CopyCadParamsConfig();

// export class CopyCadNode extends TypedCadNode<CopyCadParamsConfig> {
...
// 	private _stampNode!: CadCopyStamp;
