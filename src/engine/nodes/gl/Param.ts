...
class ParamGlSopParamsConfig extends NodeParamsConfig {
...
const ParamsConfig = new ParamGlSopParamsConfig();

export class ParamGlSopNode extends TypedGlNode<ParamGlSopParamsConfig> {
	...
	set_param_configs() {
		...
		if (param_type == ParamType.VECTOR && this.p.as_color.value) {
