...
export class AudioEventNode extends TypedEventNode<AudioEventParamsConfig> {
	...
	private _osc = new Tone.Oscillator(440, 'sine'); // export declare type ToneOscillatorConstructorOptions = ToneCustomOscillatorOptions | ToneTypeOscillatorOptions | TonePartialOscillatorOptions;
	...
	private _stop() {
		if (this._prevNote) {
			this._currentSynth.triggerRelease(this._prevNote);
		}
	}
}
