...
import {UpdateMediapipeFaceMeshActorNode} from '../../../nodes/actor/UpdateMediapipeFaceMesh';
import {UpdateMediapipeHandsActorNode} from '../../../nodes/actor/UpdateMediapipeHands';
...
export interface ActorNodeChildrenMap {
	...
	updateMediapipeFaceMesh: UpdateMediapipeFaceMeshActorNode;
	updateMediapipeHands: UpdateMediapipeHandsActorNode;
...
export class ActorRegister {
	static run(poly: PolyEngine) {
		...
		poly.registerNode(UpdateMediapipeFaceMeshActorNode, CATEGORY_ACTOR.MEDIAPIPE);
		poly.registerNode(UpdateMediapipeHandsActorNode, CATEGORY_ACTOR.MEDIAPIPE);
