...
export class GlRegister {
	static run(poly: PolyEngine) {
		...
		poly.registerNode(SDFBoxRoundGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFConeGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFConeRoundGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFContextGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFElongateGlNode, CATEGORY_GL.SDF);
		...
		poly.registerNode(SDFLinkGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFMaterialGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFMaxGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFMinGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFOctahedronGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFOnionGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFPlaneGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFRepeatGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFRepeatPolarGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFRhombusGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFSolidAngleGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFSphereGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFSubtractGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFTorusGlNode, CATEGORY_GL.SDF);
		poly.registerNode(SDFTwistGlNode, CATEGORY_GL.SDF);
