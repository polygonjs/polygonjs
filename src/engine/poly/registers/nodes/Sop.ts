...
export class SopRegister {
	static run(poly: PolyEngine) {
		...
		poly.registerNode(CADCircle2DSopNode, CATEGORY_SOP.CAD);
		poly.registerNode(CADCircle3PointsSopNode, CATEGORY_SOP.CAD);
		...
		poly.registerNode(CADSphereSopNode, CATEGORY_SOP.CAD);
		poly.registerNode(CADThicknessSopNode, CATEGORY_SOP.CAD);
		poly.registerNode(CADTorusSopNode, CATEGORY_SOP.CAD);
		...
		// CSG
		poly.registerNode(CSGArcSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGBooleanSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGBoxSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGCenterSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGCircleSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGDodecahedronSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGEllipseSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGEllipsoidSopNode, CATEGORY_SOP.CSG);
		...
		poly.registerNode(CSGLineSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGMirrorSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGOffsetSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGPolygonSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGPolyhedronSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGProjectSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGRectangleSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTransformResetSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGSphereSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGStarSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTorusSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTransform2DSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTriangulateSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTriangleSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTubeSopNode, CATEGORY_SOP.CSG);
		poly.registerNode(CSGTubeEllipticSopNode, CATEGORY_SOP.CSG);
		//
