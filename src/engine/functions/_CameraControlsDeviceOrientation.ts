...
import {Quaternion, Object3D, Euler} from 'three';
...
// but only if we are not in android + chrome
const compensateRotation = !(CoreUserAgent.isAndroid() && CoreUserAgent.isChrome());
