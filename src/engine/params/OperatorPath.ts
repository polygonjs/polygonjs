...
// 		const currentFoundEntity = this._found_node; //mode == OperatorPathMode.PARAM ? this._found_param : this._found_node;
// 		const newlyFoundEntity = node; //mode == OperatorPathMode.PARAM ? param : node;
