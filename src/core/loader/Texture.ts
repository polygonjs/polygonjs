...
// 		'ogv'
// 	]
// 	static SOURCE_TYPE_BY_EXT = {
// 		ogg: 'video/ogg; codecs="theora, vorbis"',
// 		ogv: 'video/ogg; codecs="theora, vorbis"',
// 		mp4: 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"',
// 	}
// 	static SCRIPT_URL_BY_EXT = {
// 		exr: 'EXRLoader',
// 		basis: 'BasisTextureLoader',
// 	}
// 	static THREE_LOADER_BY_EXT = {
// 		exr: 'EXRLoader',
// 		basis: 'BasisTextureLoader',
// 	}
...
// 	async load_texture_from_url_or_op(url: string):Promise<THREE.Texture|THREE.VideoTexture>{
// 		let texture;
// 		let found_node;
...
// 			if(found_node){
// 				const container = await found_node.request_container_p()
// 				texture = container.texture()

// 				// this._assign_texture(attrib, texture)
// 			} else {
// 				this._node.set_error(`no node found in path '${node_path}'`)
// 			}
...
// 				}
// 			} else {
// 				this._node.set_error(`could not load texture ${url} (${error})`);
// 			}
// 		}
...
// 				this._load_as_video(url).then((texture)=>{
// 					resolve(texture)
// 				}).catch(error=>{
...
// 					const renderer = window.POLY.renderers_controller.first_renderer()
// 					loader.detectSupport( renderer );
// 				}
// 			}
// 		}
// 		return loader || new THREE.TextureLoader();

// 		// const constructor = (() => { switch (ext) {
// 		// 	case 'exr': return EXRLoader;
// 		// 	default: return THREE.TextureLoader;
// 		// } })();
// 		// return new constructor();
// 	}

// 	_load_as_video(url: string){
// 		return new Promise((resolve, reject)=>{
...
// 			const ext = CoreTextureLoader._ext(url)
// 			const type = CoreTextureLoader.SOURCE_TYPE_BY_EXT[ext] || CoreTextureLoader._default_video_source_type(url)
...
// 	static pixel_data(texture: THREE.Texture){
...
// 	static pixel_data_to_attribute(pixel_data, geometry, attrib_name_with_component, convert_method){
...
// 			const component = attrib_name_elements[1]
...
// 			}
// 		} else {
// 			attrib = geometry.setAttribute(attrib_name, new THREE.Float32BufferAttribute(values, 1));
// 		}
...
// 	static set_texture_for_mapping(texture: THREE.Texture){
...
// 		// console.log("set_texture_for_mapping", THREE.RepeatWrapping, texture, texture.wrapS)
// 		return texture;
// 	}

// 	static async set_texture_for_env(texture: THREE.Texture, registerer: BaseNode){
